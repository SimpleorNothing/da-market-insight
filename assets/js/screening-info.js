...
(function () {
  ...
  var BLOCK_GROUPS = [
    ...
    },
    {
      ...
      keys: [
        ...
        "부동산", "아파트", "분양", "중도금", "집단대출", "주담대", "주택담보대출",
        "토허제", "토지거래허가", "전셋값",
      ],
    },
    {
  ...
  function renderBody(cfg) {
    ...
    return [
      ...
      '    <span class="scr-step__d">본문을 읽고 생활가전(DA) 사업과 무관하면 최종 제외합니다. 통과 기사는 렌즈·등급·경쟁사·요약을 부여받습니다. 분류 태그가 부동산·금융 시황이면서 가전 제품군·경쟁사가 없는 기사도 코드로 추가 제외합니다.</span>',
      "  </span></div>",
      "</div>",
