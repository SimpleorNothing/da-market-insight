...
- ★기사 발행일만 최근으로 갱신된 재게시·보도자료 재송고라도, 이미 끝난 실적 발표·콘퍼런스·전시회·출시 행사 자체를 반복 소개하며 새로운 수치·전략·후속 조치가 없으면 skip
- 특히 "N분기 실적을 발표했다/공개했다"는 사실만 있고 매출·이익·증감률·가이던스·사업 변화 등 신규 정보가 없는 요약성 실적 발표 카드는 skip
- 반대로 과거 이벤트를 언급하더라도 그 이후 새로 확인된 수치, 전략 변경, 계약, 투자, 가이던스 변화가 기사의 핵심이면 정상 분류
